    ...
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
      ...
      <footer className="bg-slate-800 text-slate-400 py-6 mt-auto">
        <div className="max-w-5xl mx-auto px-4 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} PsychoMetric Wiz. Narzędzie dydaktyczne.</p>
          <p className="text-xs mt-1 opacity-60">Symulacja procesów: KTT, Alfa Cronbacha, Steny, Trafność.</p>
        </div>
      </footer>
    </div>
  );
